...
import { Calendar, Sparkles, ArrowLeft, GraduationCap, School } from "lucide-react";
  ...
  return (
    ...
    <Dialog open={showTrialDialog} onOpenChange={setShowTrialDialog}>
      <DialogContent className="sm:max-w-md" dir="rtl">
        <DialogHeader>
          <DialogTitle className="text-center text-xl">اختر نوع المؤسسة</DialogTitle>
        </DialogHeader>
        <div className="grid grid-cols-2 gap-4 mt-4">
          <a
            href="https://jadwala-v1.lovable.app/auth"
            target="_blank"
          ...
          >
            ...
            <span className="text-lg font-semibold">جامعة</span>
          </a>
          <a
            href="https://school-v1.lovable.app"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center gap-3 p-6 rounded-xl border-2 border-primary/20 hover:border-primary hover:bg-primary/5 transition-all cursor-pointer"
            onClick={() => setShowTrialDialog(false)}
          >
            ...
            <span className="text-lg font-semibold">مدرسة</span>
          </a>
        </div>
      </DialogContent>
    </Dialog>
